...
const BtnElement = styled.span`
  ${({
    ...
    border: ${noBorder ? 0 : 1}px solid ${borderColor ||
    color ||
    dfstyles.colors.borderDark};
    ...
    &:hover {
      ...
      css`
        ...
        border: ${noBorder ? 0 : 1}px solid
          ${borderColor || color || dfstyles.colors.border};
    ...
    &:active {
      ...
      css`
        background: ${color ||
        colorFn(dfstyles.colors.text).lighten(0.5).hex()};
      `}
    }
    ${disabled &&
    css`
