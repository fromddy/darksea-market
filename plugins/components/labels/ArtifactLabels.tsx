...
const ArtifactTypeTextRaw = ({
  ...
  isOffer
    ? ArtifactTypeNames[artifact.artifactType].replace("Unknown", "Any Type")
...
export const ArtifactRarityTypeLabelAnim = ({
  artifact,
  isOffer,
}: {
  artifact: Artifact;
